...
public class AddCOs : MonoBehaviour
{
    ...
    public void onClickAddNew()
    {
        ...
        if (!showing)
        {
            ...
            iTween.MoveBy(newPbtn, iTween.Hash("y", Screen.height * 0.1, "easeType", "easeInOutExpo", "time", 0.3));
            ...
            iTween.MoveBy(newAbtn, iTween.Hash("y", Screen.height * 0.2, "easeType", "easeInOutExpo", "time", 0.3));
    ...
    {
        iTween.MoveBy(newPbtn, iTween.Hash("y", -Screen.height * 0.1, "easeType", "easeInOutExpo", "time", 0.3, "delay", delay));
        ...
        iTween.MoveBy(newAbtn, iTween.Hash("y", -Screen.height * 0.2, "easeType", "easeInOutExpo", "time", 0.3, "delay", delay));
